...
设置场景中的参与方情况
1、设置参与方个数及具有的数据库数目
2、设置每个参与方的参与共享交换的数据库数目，并随机设置相应的共享数据库形成列表（共享资源目录）
'''

import random
import pickle

ParticipantNum = 4  # 参与方个数
...
# print(DB_num_list)
DB_sharing_num_list = [round(x * 1/3) for x in DB_num_list]  # 参与方各自参与共享交换的数据库数量
# print(DB_sharing_num_list)
